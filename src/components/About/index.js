      ...
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            established IT company with the oppurtunityto work with the latest
            technology on challenging and diverse projects{' '}
          </p>
          <p>
            I'm quietly confident, naturally curious, and perpectually working
            on improving my chops one design problem at a time.
          </p>
          <p>
            If I need to define myself in one sentence that would be a family
            person, a football fanatic, a sports person and tech-obsessed!!
          </p>
        </div>
